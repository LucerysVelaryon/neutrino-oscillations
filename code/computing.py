...
def computing(methods = "all", n = 100000) :
    ...
    for i in range(n):
        ...
        """ Setting a_33 to 1 to comply with the expression of the charged
        letpon mass matrix in the model, expressed in units of m_tau. """
        a[3,3] = 1
        ...
        Simone Marciano in his thesis, without and with taking into account the
        ...
        """ The following method takes into account the reasoning made by
        Simone Marciano in his thesis, especially concerning the ranges of
        the parameters of the model, but computes the mixing angles using in a
        ...
        if "numerical" in methods :
            ...
            the computing of the angles are minus 1 the one used in theoretical
            formulae in the literature (U_13 in an article will be U_02 in this
            code). """
